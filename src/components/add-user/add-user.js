...
function AddUser(props) {
    const { classes, toggleAddView } = props;
    ...
    return (
        <div className={classes.root}>
            ...
            <Grid container spacing={0}>
                <Grid item xs={12}>
                    <Formik
                        initialValues={{ email: '', name: '', contact: '', address: '' }}
                        onSubmit={(values) => {
                            const userValues = { id: uuid.v4(), ...values, date: new Date().toDateString() }
                            dispatch(userActions.addUser(userValues));
                            toggleAddView();
                        }}
                            ...
                            return (
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        <Button variant="outlined" color={theme.themeColor} onClick={toggleAddView}>
                                            Cancel
                                        </Button>
                                    </Grid>
                                </form>
